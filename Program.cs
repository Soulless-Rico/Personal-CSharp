...
public static class Formatter
{
    public static void Main()
    {
        ...
        // Task spinnerTask = HelperFunctions.StartSpinner(cts.Token);
        ...
        try
        {
            ...
            TvcbClass.SecondaryNavigation(toFormatWs, genWs);
            var (listsOfAllData, listOfDirectionColumns, allDirectionsList) = TvcbClass.PrimaryDataReading(genWs, toFormatWs);
            TvcbClass.PrimaryDataWriting(genWs, toFormatWs, listsOfAllData, listOfDirectionColumns, allDirectionsList);
            TvcbClass.Style(toFormatWs);

            // AM, Midday, PM Peaks
            DayPeaksClass.GenerateWorksheet(toFormatPackage, genPackage);
